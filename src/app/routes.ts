...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "ssom", lazy: lazyPage(() => import("./pages/SSOMPage"), "SSOMPage") },
      ...
      { path: "contact", loader: redirectTo("/design-partner") },
      { path: "design-partner", lazy: lazyPage(() => import("./pages/DesignPartnerPage"), "DesignPartnerPage") },
